        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
            ...
            <ul class="space-y-2 font-medium">
               ...
               <li>
                    ...
                    @else
                        <a href="{{ $link['href'] }}"
                                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black dark:hover:text-black dark:hover:bg-gray-700 group hover:text-black {{ $link['active'] ? 'bg-gray-100' : '' }}"                            <span class="w-6 h-6 inline-flex justify-center items-center text-gray-500">
